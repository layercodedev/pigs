DONE: the blessed terminal implementation causes issues with the full screen claude code tui. Rewrite the pigs application to be based around tmux, so that attaching to a sprites is done with the host's sprite cli commands. e.g.:

new VM: sprite -s pigs-vigzq0 exec -tty claude
reattach: sprite sessions attach <id>

# Working with Sprites

Source: https://docs.sprites.dev/working-with-sprites/
